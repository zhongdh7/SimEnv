...
(cl:defmethod cl:initialize-instance :after ((m <Hazard3D>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hazard3D)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hazard_perception-msg:<Hazard3D> is deprecated: use hazard_perception-msg:Hazard3D instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <Hazard3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hazard_perception-msg:id-val is deprecated.  Use hazard_perception-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <Hazard3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hazard_perception-msg:position-val is deprecated.  Use hazard_perception-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <Hazard3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hazard_perception-msg:confidence-val is deprecated.  Use hazard_perception-msg:confidence instead.")
  (confidence m))

(cl:ensure-generic-function 'observation_count-val :lambda-list '(m))
(cl:defmethod observation_count-val ((m <Hazard3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hazard_perception-msg:observation_count-val is deprecated.  Use hazard_perception-msg:observation_count instead.")
  (observation_count m))

(cl:ensure-generic-function 'confirmed-val :lambda-list '(m))
(cl:defmethod confirmed-val ((m <Hazard3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hazard_perception-msg:confirmed-val is deprecated.  Use hazard_perception-msg:confirmed instead.")
  (confirmed m))

(cl:ensure-generic-function 'localization_source-val :lambda-list '(m))
(cl:defmethod localization_source-val ((m <Hazard3D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hazard_perception-msg:localization_source-val is deprecated.  Use hazard_perception-msg:localization_source instead.")
