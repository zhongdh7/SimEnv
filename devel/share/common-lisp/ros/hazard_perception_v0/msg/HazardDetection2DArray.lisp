...
(cl:defclass <HazardDetection2DArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (detections
    :reader detections
    :initarg :detections
    :type (cl:vector hazard_perception_v0-msg:HazardDetection2D)
   :initform (cl:make-array 0 :element-type 'hazard_perception_v0-msg:HazardDetection2D :initial-element (cl:make-instance 'hazard_perception_v0-msg:HazardDetection2D))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <HazardDetection2DArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HazardDetection2DArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hazard_perception_v0-msg:<HazardDetection2DArray> is deprecated: use hazard_perception_v0-msg:HazardDetection2DArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <HazardDetection2DArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hazard_perception_v0-msg:header-val is deprecated.  Use hazard_perception_v0-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'image_width-val :lambda-list '(m))
(cl:defmethod image_width-val ((m <HazardDetection2DArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hazard_perception_v0-msg:image_width-val is deprecated.  Use hazard_perception_v0-msg:image_width instead.")
  (image_width m))

(cl:ensure-generic-function 'image_height-val :lambda-list '(m))
(cl:defmethod image_height-val ((m <HazardDetection2DArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hazard_perception_v0-msg:image_height-val is deprecated.  Use hazard_perception_v0-msg:image_height instead.")
  (image_height m))

(cl:ensure-generic-function 'detections-val :lambda-list '(m))
(cl:defmethod detections-val ((m <HazardDetection2DArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hazard_perception_v0-msg:detections-val is deprecated.  Use hazard_perception_v0-msg:detections instead.")
  (detections m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HazardDetection2DArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'detections)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'hazard_perception_v0-msg:HazardDetection2D))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<HazardDetection2DArray>)))
  ...
  "hazard_perception_v0/HazardDetection2DArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'HazardDetection2DArray)))
  "Returns string type for a message object of type 'HazardDetection2DArray"
  "hazard_perception_v0/HazardDetection2DArray")
