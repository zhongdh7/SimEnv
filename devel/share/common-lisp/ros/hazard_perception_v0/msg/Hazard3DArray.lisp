...
(cl:defclass <Hazard3DArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (hazards
    :reader hazards
    :initarg :hazards
    :type (cl:vector hazard_perception_v0-msg:Hazard3D)
   :initform (cl:make-array 0 :element-type 'hazard_perception_v0-msg:Hazard3D :initial-element (cl:make-instance 'hazard_perception_v0-msg:Hazard3D))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Hazard3DArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hazard3DArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hazard_perception_v0-msg:<Hazard3DArray> is deprecated: use hazard_perception_v0-msg:Hazard3DArray instead.")))
...
(cl:defmethod hazards-val ((m <Hazard3DArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hazard_perception_v0-msg:hazards-val is deprecated.  Use hazard_perception_v0-msg:hazards instead.")
  (hazards m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Hazard3DArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'hazards)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'hazard_perception_v0-msg:Hazard3D))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Hazard3DArray>)))
  ...
  "hazard_perception_v0/Hazard3DArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Hazard3DArray)))
  "Returns string type for a message object of type 'Hazard3DArray"
  "hazard_perception_v0/Hazard3DArray")
