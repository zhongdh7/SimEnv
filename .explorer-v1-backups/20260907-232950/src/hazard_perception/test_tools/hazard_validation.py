...
from hazard_perception.msg import Hazard3DArray, HazardDetection2DArray
...
class HazardValidationNode:
    ...
    def _load_parameters(self):
        ...
        self.hazards_topic = str(get("~hazards_topic", "/hazard_perception/hazards_3d"))
        ...
        self.debug_topic = str(get("~debug_topic", "/hazard_perception/pipeline_debug_image"))
        self.detections_topic = str(get("~detections_topic", "/hazard_perception/detections"))
