...
std::string decode_sn(const std::vector<uint8_t> &data) {
  ...
  switch (type) {
    case DogType::Laikago: type_name = "Laikago";
      break;
    case DogType::Aliengo: type_name = "Aliengo";
      break;
    case DogType::A1: type_name = "A1";
      break;
    case DogType::Go1: type_name = "Go1";
      break;
    case DogType::B1: type_name = "B1";
      break;
  }
  ...
  switch (model) {
    case ModelType::AIR: model_name = "AIR";
      break;
    case ModelType::PRO: model_name = "PRO";
      break;
    case ModelType::EDU: model_name = "EDU";
      break;
    case ModelType::PC: model_name = "PC";
      break;
    case ModelType::XX: model_name = "XX";
      break;
  }
