...
from hazard_perception_v0.msg import HazardDetection2D, HazardDetection2DArray
...
class HazardDetectorNode:
    def __init__(self):
        ...
        detections_topic = rospy.get_param(
            "~detections_topic", "/hazard_perception_v0/detections"
        )
        mask_topic = rospy.get_param("~mask_topic", "/hazard_perception_v0/red_mask")
        debug_image_topic = rospy.get_param(
            "~debug_image_topic", "/hazard_perception_v0/debug_image"
        )
