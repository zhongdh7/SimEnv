...
class CompetitionNavigation(object):
    def __init__(self):
        ...
        self.model_path = rospy.get_param(
            "~model_path",
            "/home/loser/HDPlanner_Exp_and_Nav/model/HDPlanner_Nav/policy_traced.pt",
        )
        self.library_path = rospy.get_param(
            "~library_path",
            "/home/loser/SimEnv/devel/lib/libhdplanner_inference.so",
        )
        ...
        self.map_pub = rospy.Publisher("/explore_full/map", OccupancyGrid, queue_size=1, latch=True)
        self.floor_map_pubs = [
            rospy.Publisher(
                "/explore_full/map_floor_%d" % floor,
                OccupancyGrid,
                queue_size=1,
                latch=True,
            )
        ...
        self.waypoint_pub = rospy.Publisher("/explore_full/waypoint", PoseStamped, queue_size=1)
        self.status_pub = rospy.Publisher("/explore_full/status", String, queue_size=2)
        ...
        rospy.Service("/explore_full/start", Trigger, self.start_callback)
        rospy.Service("/explore_full/return_home", Trigger, self.return_home_callback)
        rospy.Service("/explore_full/set_home", Trigger, self.set_home_callback)
        rospy.Service("/explore_full/stop", Trigger, self.stop_callback)
