...
WAYPOINTS = [
    ...
    # === Phase 6: Transit to far corridor ===
    ( 0.511, 28.162,  1.572),

    # === Phase 7: Far-left rooms ===
    (-2.365, 28.269,  3.120),
    (-7.255, 33.750, -0.652),
    (-7.291, 22.966,  0.623),
    ...
    # === Phase 9: Far-right rooms ===
    ( 2.784, 28.069,  0.000),
    ( 8.394, 33.405, -2.587),
    ( 8.596, 22.847,  2.582),

    # === Phase 10: Back to corridor & return ===
    ( 3.102, 27.996,  3.114),
    ( 0.440, 28.162, -3.131),
    ( 0.050,  1.997, -1.489),
    (-2.696,  1.974, -3.134),
