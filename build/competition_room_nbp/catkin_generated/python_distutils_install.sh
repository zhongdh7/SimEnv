...
echo_and_run cd "/home/loser/SimEnv/src/competition_room_nbp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/loser/SimEnv/src/competition_room_nbp/setup.py" \
    egg_info --egg-base /home/loser/SimEnv/build/competition_room_nbp \
    build --build-base "/home/loser/SimEnv/build/competition_room_nbp" \
    install \
    --root="${DESTDIR-/}" \
