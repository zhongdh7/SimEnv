...
echo_and_run cd "/home/loser/SimEnv/src/hazard_perception"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/loser/SimEnv/build/hazard_perception \
    build --build-base "/home/loser/SimEnv/build/hazard_perception" \
    install \
    --root="${DESTDIR-/}" \
