...
echo_and_run cd "/home/loser/SimEnv/src/hazard_perception_v0"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/loser/SimEnv/src/hazard_perception_v0/setup.py" \
    egg_info --egg-base /home/loser/SimEnv/build/hazard_perception_v0 \
    build --build-base "/home/loser/SimEnv/build/hazard_perception_v0" \
    install \
    --root="${DESTDIR-/}" \
